      ...
      <main className="flex flex-1 items-center justify-center p-4">
        ...
        >
          <div className="mb-8 text-center">
            <h1 className="text-2xl font-bold tracking-tight text-zinc-950 dark:text-white">Welcome back</h1>
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <Link href="/register" className="font-medium text-zinc-950 hover:underline dark:text-white">
              Sign up
            </Link>
          </div>
        </motion.div>
