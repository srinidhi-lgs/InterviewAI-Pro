    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                final UserDetails userDetails = this.customUserDetailsService.loadUserByUsername(userEmail);
            ...
            // Gracefully handle invalid, malformed, or expired tokens without crashing the request pipeline.
